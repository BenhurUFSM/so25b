...
A planilha tem (ou tera') os horarios de apresentacao.
As apresentacoes sao na sala 376, anexo B.

Quem pode apresentar hoje (25) de tarde? Manda mail pra benhur@inf.ufsm.br.
